...
if($action=='paysubmit'){
	...
	switch($feetype){
		case "alipay":
			...
			$payAmount = $rowContent['tepay_price'];          //付款金额，单位:元
			...
			if($result['code'] && $result['code']=='10000'){
				...
				'feecid'   =>  $feecid,
				'feeuid'     =>  $feeuid,
				'feeprice'=> $rowContent['tepay_price'],
				'feetype'     =>  $feetype,
				'feestatus'=>0,
				'feeinstime'=>date('Y-m-d H:i:s',$time),
				'feecookie'=>$feecookie
				);
				$insert = $db->insert('table.tepay_fees')->rows($data);
		...
		case "wxpay":
			...
			$arr = [
				...
				'total_fee' => $rowContent["tepay_price"]*100,             // 金额,单位:分
				'attach'=>$rowContent["tepay_price"]// 自定义数据
			];
